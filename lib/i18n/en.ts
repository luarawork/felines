...
export const en = {
  nav: {
    ...
    menuLabelUnread: "Account menu, {count} unread notifications",
    navLabel: "Main navigation",
    colonyTabsAriaLabel: "Colony sections",
    mapIllustrationAlt: "Illustration of the colony map",
    anonymousCommunityMember: "Someone from the community",
  ...
  colony: {
    ...
    statsTab: {
      ...
      healthAriaLabel: "Colony health: {status}, score {score} out of 100",
      castrationProgressAriaLabel: "{percent}% of cats neutered",
      healthExplainer:
  ...
  forms: {
    ...
    resource: {
      ...
      locationLabel: "Neighborhood (never the exact address)",
  ...
  map: {
    ...
    interactiveMapAria: "Interactive map of cat colonies",
  ...
  contacts: {
    ...
    filterCityAriaLabel: "Filter contacts by city",
