...
import { getReportTypeLabel, REPORT_TYPES } from "@/lib/content/reportTypes";
import EmptyState from "@/components/shared/EmptyState";
import FlagButton, { getFlagReasonLabel } from "@/components/reports/FlagButton";
import SightingReportButton from "@/components/reports/SightingReportButton";
                    ...
                    <div className="flex gap-2">
                      {report.created_by !== session.user.id && (
                        <button
                          ...
                          className="rounded-full border border-felines-accent px-3 py-1 text-xs font-medium text-felines-accent-hover transition-colors hover:bg-felines-accent hover:text-white disabled:opacity-50"
                        >
